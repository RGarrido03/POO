...
public class DateNDTest {
    private static int mainMenu(Scanner sc) {
        ...
        System.out.println("1. Create new date (YMD format)");
        System.out.println("2. Create new date (days format)");
        System.out.println("3. Show current date");
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            switch(opt) {
                ...
                case 2 -> {
                    int days = UserInput.inputInt(sc, "Input the number of days after 2000-01-01:");
